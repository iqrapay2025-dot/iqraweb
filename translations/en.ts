export const en = {
  ...
  ambassadors: {
    ...
    subtitle: "Help spread quality education and earn rewards by sharing IqraPay with your community. Be part of a global movement empowering learners through skill development.",
    
    whatIsTitle: "What is the Ambassador Program?",
    whatIsPara1: "The IqraPay Ambassador Program is designed for passionate individuals who want to make a difference in their communities while earning income.",
    whatIsPara2: "As an ambassador, you'll be the bridge between IqraPay and potential learners, sharing our mission of combining quality education with ethical earning opportunities.",
    whatIsPara3: "Whether you're an influencer, community leader, student, or simply someone who believes in our vision, we welcome you to join this transformative journey.",
    ...
    req1: "Passionate about education and skill development",
    req2: "Strong social media presence or community influence",
    req3: "Committed to quality learning and ethical earning",
    req4: "Dedicated to representing IqraPay values",
    req5: "Minimum 18 years of age",
    
    ctaTitle: "Ready to Make an Impact?",
    ctaDesc: "Join our global team of ambassadors and help spread quality education while earning rewards. Your journey starts here.",
  ...
  blog: {
    ...
    subtitle: "Latest news, learning insights, and community stories",
  ...
  contact: {
    ...
    newsletterDesc: "Stay updated with latest features, learning content, and community news",
    ...
    supportTime: "Monday - Friday: 9:00 AM - 6:00 PM (GMT)",
    supportNote: "Weekend support available via email",
  },
  ...
  support: {
    ...
    // Footer Note
    footerNote: "IqraPay is an Islamic social enterprise. All reward pools are Shariah-compliant.",
    
    // Success/Error Messages
    successTitle: "Message sent successfully!",
    successMessage: "We'll get back to you soon to discuss your sponsorship.",
  },
  
  // Newsletter
  newsletter: {
    title: "Stay Updated with IqraPay",
    description: "Subscribe to our newsletter for the latest updates on learning opportunities, platform features, and exclusive content delivered to your inbox.",
